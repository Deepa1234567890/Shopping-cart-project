<%@page import="org.project.model.Product"%>
<%@page import="java.util.List"%>
<%@page import="org.project.Dao.ProductDao"%>
				...
				<div class="card w-100" style="width: 18rem">
					...
					<div class="card-body">
						...
						<div class="mt-3 d-flex justify -content -between">
							<a href=" add-to-cart?id=<%=p.getId()%>" class="btn btn-dark" style='margin-right:8px'>Add to Cart</a>
